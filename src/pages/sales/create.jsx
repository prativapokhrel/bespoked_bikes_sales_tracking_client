...
export default function CreateSale(){
    ...
    const {data, isLoading: isLoadinProducts, isError, error: productError, isSuccess: isProductsSuccess} = useGetAllProducts();
 ...
 const {mutate, isLoading, isSuccess, error} = useCreateSale();
    ...
    return(
        <div className="mx-10 my-4">
            <form onSubmit={handleSubmit}>
                ...
                <Select label="Sales Person" name="salesperson_id" items={persons} value={state.salesperson_id} onChange={handleInputChange} />
